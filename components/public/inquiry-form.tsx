  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      <div className="grid gap-6 sm:grid-cols-2">
        ...
        <Input label="部署名" id="departmentName" {...register("departmentName")} error={errors.departmentName?.message as string} />
      </div>
      <div className="grid gap-6 sm:grid-cols-2">
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        <Input label="電話番号" id="phone" {...register("phone")} error={errors.phone?.message as string} />
      ...
      <Textarea label="備考" id="note" rows={4} {...register("note")} error={errors.note?.message as string} />
